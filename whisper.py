...
fname_model = f"{whisper_folder}/models/ggml-base.bin"
fname_wav   = f"{whisper_folder}/samples/french.wav"
language = b"fr"
is_verbose = False

# 1. sh download-ggml-model.sh base
# 2. ./main -m models/ggml-base.bin -f samples/french.wav -l fr
# 3. sh pybind.sh
# 4. 
